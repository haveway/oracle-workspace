...
INSERT INTO MEMBER 
VALUES (SEQ_UNO.NEXTVAL, 'user01', 'pass01', '이승철', '010-3333-4444', 'user01@kh.or.kr', '서울시 양천구 목동', NULL, SYSDATE, SYSDATE, DEFAULT);

INSERT INTO MEMBER 
VALUES (SEQ_UNO.NEXTVAL, 'user02', 'pass02', '홍길동', '010-7444-1234', 'user02@kh.or.kr', '서울시 강서구 화곡동', NULL, SYSDATE, SYSDATE, DEFAULT);
...
INSERT INTO NOTICE
VALUES (SEQ_NNO.NEXTVAL, '첫번째 공지사항입니다.', '첫번째 공지사항 내용입니다.', 1, DEFAULT, '2022-02-10', DEFAULT);

INSERT INTO NOTICE
VALUES (SEQ_NNO.NEXTVAL, '두번째 공지사항입니다.', '두번째 공지사항 내용입니다.', 1, DEFAULT, '2022-02-21', DEFAULT);
